...
Fill in your details and get them correct, if you don't know your name, group and tutor you can't expect marks! (delete this line when done), correctly filling in ReadMe.md is generously part of the marking scheme!
# Name: [Your Name]
# Group: [Your Group]
# Tutor: [Your Tutor]
# Course: [Your Course]
...
You must follow these instructions, they aren't hard and you will losse marks if you don't. This applies to **both** assignments.
...
### You must provide a YouTube Demo that is uploaded as public but unlistable, and the link must be provided in the README.md file. The demo should showcase the functionality of your assignments. See Assignment Specification on myBeckett and [YouTube demo software document](https://docs.google.com/document/d/1soUvlj9sm1gEJVbgrrJbKRKm0WyZrasGAaf3ROYx-ZM/edit?usp=sharing).
### You must fill in the demo script (it tells you what to show) AND show it in your video, you must submit the demo script. 
...
**Module Leaders cannot give out extensions, so don't ask, instead click the above link**
